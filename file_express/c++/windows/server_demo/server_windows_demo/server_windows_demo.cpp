...
bool on_progress(int express_handle, void *param, char* file_path, int max, int cur)
{
	return false;
}

void on_finish(int express_handle, void *param, char* file_path, long long size)
{
