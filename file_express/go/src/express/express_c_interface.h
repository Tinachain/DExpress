...
typedef bool (*EXPRESS_PROGRESS)(int express_handle, void *param, char *file_path, int max, int cur);
typedef void (*EXPRESS_FINISH)(int express_handle, void *param, char *file_path, long long size);
