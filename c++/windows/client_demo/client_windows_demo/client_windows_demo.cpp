...
int main()
{
	...
	//加载dll
	std::string current_path = "D:/projects/Chainware/最终产品/windows/lib/client/client.dll";
	...
	for (auto iter = remote_array.begin(); iter != remote_array.end(); iter++)
	{
		...
		//连接服务端
		std::string libharqpath = "D:/projects/Chainware/最终产品/windows/lib/harq/harq.dll";
