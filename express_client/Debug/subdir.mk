...
/mnt/hgfs/public/rudp/client/rudp/rudp_socket.cpp \
...
/mnt/hgfs/public/rudp/client/rudp/rudp_socket.o \
...
/mnt/hgfs/public/rudp/client/rudp/rudp_socket.d \
...
/mnt/hgfs/public/files/%.o: /mnt/hgfs/public/files/%.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C++ Compiler'
	g++ -g -std=c++0x -I/mnt/hgfs/public/header \
							-I/mnt/hgfs/public/files -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
/mnt/hgfs/public/rudp/header/fec/%.o: /mnt/hgfs/public/rudp/header/fec/%.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C++ Compiler'
	g++ -g -std=c++0x -I/mnt/hgfs/public/rudp/header/include \
							-I/mnt/hgfs/public/rudp/header/fec \
							-I/mnt/hgfs/public/rudp/header -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
/mnt/hgfs/public/rudp/header/thread/%.o: /mnt/hgfs/public/rudp/header/thread/%.cpp
	...
	@echo 'Invoking: GCC C++ Compiler'
	g++ -g -std=c++0x -I/mnt/hgfs/public/header \
							-I/mnt/hgfs/public/rudp/header/include -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '		
...
/mnt/hgfs/public/rudp/header/channel/%.o: /mnt/hgfs/public/rudp/header/channel/%.cpp
	...
	g++ -g -std=c++0x -I/mnt/hgfs/public/header \
							-I/mnt/hgfs/public/rudp/header/include \
							-I/mnt/hgfs/public/rudp/header/fec -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
	
# RUDP Server Socket
/mnt/hgfs/public/rudp/client/rudp/%.o: /mnt/hgfs/public/rudp/client/rudp/%.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C++ Compiler'
	g++ -g -std=c++0x -I/mnt/hgfs/public/header \
							-I/mnt/hgfs/public/rudp/header/include \
							-I/mnt/hgfs/public/rudp/header/fec \
							-I/mnt/hgfs/public/rudp/header/group \
							-I/mnt/hgfs/public/rudp/header/encrypt \
							-I/mnt/hgfs/public/rudp/header/encrypt/aes \
							-I/mnt/hgfs/public/rudp/header/channel \
							-I/mnt/hgfs/public/rudp/header/thread \
							-I/mnt/hgfs/public/rudp/header/frames \
							-I/mnt/hgfs/public/rudp/client/rudp -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
